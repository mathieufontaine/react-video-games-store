  ...
  return (
    <>
      ...
      <div className="wishlist">
        <div className="added-list mobile">
          ...
          {wishlistGames.length > 0 ? (
            ...
            <div className="empty-list empty-wishlist">
              No Games.
              <p>
                To update your Top List or your Custom Lists, you need to add
        ...
        <h2 className="section-title black">My Lists</h2>
            ...
            <div className="lists-section">
              ...
              {customLists.length ? (
                ...
                <div className="empty-list empty-wishlist">
                  ...
                  <p>
                    <strong>1. </strong>Use the form above to give a name to
                    your list.
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    clicking on "add to custom list".
                  </p>
                  <p>
